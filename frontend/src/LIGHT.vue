...
<style lang="less">
  ...
  .ant-menu-purple, .ant-menu-purple .ant-menu-sub {
    color: rgba(255, 255, 255, 0.75) !important;
    background: #393e46 !important;
  }
  .ant-menu-purple .ant-menu-item, .ant-menu-purple .ant-menu-item-group-title, .ant-menu-purple .ant-menu-item > a {
    color: rgba(255, 255, 255, 0.75);
}

  .ant-menu-purple .ant-menu-inline.ant-menu-sub {
    box-shadow: 0 2px 8px rgba(0, 0, 0, 0.2) inset !important;
  }

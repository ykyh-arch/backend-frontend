...
public class LightUtil {
    ...
    public static String encryptToken(String token) {
        try {
            EncryptUtil encryptUtil = new EncryptUtil(LightConstant.TOKEN_CACHE_PREFIX);

...
public class LightConstant {
    ...
    // user缓存前缀
    public static final String USER_CACHE_PREFIX = "light.cache.user.";
    // user角色缓存前缀
    public static final String USER_ROLE_CACHE_PREFIX = "light.cache.user.role.";
    // user权限缓存前缀
    public static final String USER_PERMISSION_CACHE_PREFIX = "light.cache.user.permission.";
    // user个性化配置前缀
    public static final String USER_CONFIG_CACHE_PREFIX = "light.cache.user.config.";
    // token缓存前缀
    public static final String TOKEN_CACHE_PREFIX = "light.cache.token.";

    // 存储在线用户的 zset前缀
    public static final String ACTIVE_USERS_ZSET_PREFIX = "light.user.active";

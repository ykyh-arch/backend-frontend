package cn.uetec.light.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/intelligent_light?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "root";
    // 数据库密码
    private static final String PASSWORD = "Uetec123";
    // @author 值
    private static final String AUTHOR = "ykyh";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "cn.uetec.light";
    // xml文件路径

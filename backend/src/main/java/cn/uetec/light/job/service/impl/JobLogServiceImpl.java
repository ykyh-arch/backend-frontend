package cn.uetec.light.job.service.impl;
...
import cn.uetec.light.job.dao.JobLogMapper;
...
public class JobLogServiceImpl extends ServiceImpl<JobLogMapper, JobLog> implements JobLogService {
    ...
    public IPage<JobLog> findJobLogs(QueryRequest request, JobLog jobLog) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "createTime", LightConstant.ORDER_DESC, true);

package cn.uetec.light.job.controller;
...
import cn.uetec.light.job.service.JobService;
...
public class JobController extends BaseController {
    ...
    public void addJob(@Valid Job job) throws LightException {
        try {
    ...
    public void deleteJob(@NotBlank(message = "{required}") @PathVariable String jobIds) throws LightException {
        try {
    ...
    public void updateJob(@Valid Job job) throws LightException {
        try {
    ...
    public void runJob(@NotBlank(message = "{required}") @PathVariable String jobId) throws LightException {
        try {
    ...
    public void pauseJob(@NotBlank(message = "{required}") @PathVariable String jobId) throws LightException {
        try {
    ...
    public void resumeJob(@NotBlank(message = "{required}") @PathVariable String jobId) throws LightException {
        try {
    ...
    public void export(QueryRequest request, Job job, HttpServletResponse response) throws LightException {
        try {

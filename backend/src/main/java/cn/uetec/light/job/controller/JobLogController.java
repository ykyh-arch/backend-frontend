...
import cn.uetec.light.job.domain.JobLog;
import cn.uetec.light.job.service.JobLogService;
...
public class JobLogController extends BaseController {
    ...
    public void deleteJobLog(@NotBlank(message = "{required}") @PathVariable String jobIds) throws LightException {
        try {
    ...
    public void export(QueryRequest request, JobLog jobLog, HttpServletResponse response) throws LightException {
        try {

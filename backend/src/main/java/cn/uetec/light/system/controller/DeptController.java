...
import cn.uetec.light.system.service.DeptService;
...
public class DeptController extends BaseController {
    ...
    public void addDept(@Valid Dept dept) throws LightException {
        try {
    ...
    public void deleteDepts(@NotBlank(message = "{required}") @PathVariable String deptIds) throws LightException {
        try {
    ...
    public void updateDept(@Valid Dept dept) throws LightException {
        try {
    ...
    public void export(Dept dept, QueryRequest request, HttpServletResponse response) throws LightException {
        try {

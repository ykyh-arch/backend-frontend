...
import cn.uetec.light.system.domain.RoleMenu;
import cn.uetec.light.system.service.RoleMenuServie;
...
public class RoleController extends BaseController {
    ...
    public void addRole(@Valid Role role) throws LightException {
        try {
    ...
    public void deleteRoles(@NotBlank(message = "{required}") @PathVariable String roleIds) throws LightException {
        try {
    ...
    public void updateRole(Role role) throws LightException {
        try {
    ...
    public void export(QueryRequest queryRequest, Role role, HttpServletResponse response) throws LightException {
        try {
